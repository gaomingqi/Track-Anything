...
def vis_add_mask(image, background_mask, contour_mask, background_color, contour_color, background_alpha,
                 contour_alpha):
...
def mask_painter(input_image, input_mask, background_alpha=0.5, background_blur_radius=7, contour_width=3,
...
if __name__ == '__main__':
    ...
    for i in range(50):
        t2 = time.time()
        painted_image_00 = mask_painter(input_image, input_mask, background_alpha, background_blur_radius,
                                        contour_width, contour_color, contour_alpha, mode='00')
        e2 = time.time()

        t3 = time.time()
        painted_image_10 = mask_painter(input_image, input_mask, background_alpha, background_blur_radius,
        ...
        t4 = time.time()
        painted_image_01 = mask_painter(input_image, input_mask, background_alpha, background_blur_radius,
                                        contour_width, contour_color, contour_alpha, mode='01')
        e4 = time.time()

        t5 = time.time()
        painted_image_11 = mask_painter(input_image, input_mask, background_alpha, background_blur_radius,
